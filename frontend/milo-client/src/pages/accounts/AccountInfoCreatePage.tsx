...
import { createAccountInfo } from "../../services/accountInfoService";
import {
  ArrowLeft,
  ChevronDown,
  CreditCard,
...
function AccountInfoCreatePage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.error("Hesap bilgisi eklenemedi:", error);
    }
  };
    ...
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8">
        ...
        <p className="text-zinc-400 text-sm mb-6">
          Bir platformun giriş bilgilerini güvenle sakla.
        </p>
...
export default AccountInfoCreatePage;
